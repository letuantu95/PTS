 ...
 BLYNK_WRITE(VcheckAll)
  {
    ...
    {
    String stt[2] = {"on", "off"};      
    String allStt ="{ The temperature is "+String(t)+"°C. \The humidity is\ "+String(h)+"%. \Gas concentration\ "+String(g)+". \The light in bedroom is\ " +stt[x]+". \The light in Kitchen is\ " +stt[k]+". \The fan is\ "+stt[y]+". \The heater is\ "+ stt[z]+"}";  
...
//  Blynk.virtualWrite(VledBedRoom, x);
//  Blynk.virtualWrite(Vfan, y);
//  Blynk.virtualWrite(Vheater, z);
//  Blynk.virtualWrite(VledKitchen, k);
  if((digitalRead(D1)==LOW)&&(t>=35))
  {
